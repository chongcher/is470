...
public class addPastResponsesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for(String r: allResponsesList){
            //creates a dummy user and response
            String userID = lectureID + "-user" + (String.format("%04d", counter++));
            System.out.println("user: " + userID);
            String passwordHash = request.getParameter("$2a$08$ep5NqXn1ZGd5H/kfVHzHFe8n2kql3ZbsvNQ102GgmZX8kXdhEfEHG");//default password is qwe

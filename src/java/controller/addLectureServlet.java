...
public class addLectureServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //write lecture to database
        HttpSession session = request.getSession();
        LectureDAO lectureDAO = (LectureDAO) session.getAttribute("lectureDAO");
        boolean success = lectureDAO.addLecture(lectureID, keywords);
        String displayMessage = "";
        if(success) displayMessage += "Successfully added lecture \"" + lectureID + "\"";
        else displayMessage += "Error! Did not add lecture\"" + lectureID + "\"!";
